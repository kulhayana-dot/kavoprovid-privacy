...
const FEATURES = [
  ...
  },
  {
    ...
    points: [
      "Повідомлення про проблему з фото та коротким описом",
      "Попередній AI-аналіз проблеми",
      "Кнопка «Викликати кавопровідника» — спершу дистанційне рішення, план виїзду лише якщо дистанційно не вдалось",
    ],
  },
];
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="max-w-2xl">
          ...
          <p className="mt-5 text-ink/60">
            ...
            управління кавовим потоком: план споживання, замовлення й сервіс
            в одному місці. Доступний клієнтам KAVOPROVID на iOS та Android
            після онбордингу.
          </p>
        </div>
