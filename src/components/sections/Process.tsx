...
const STEPS = [
  {
    ...
    text: "Скільки людей, який ритм дня, де стоятиме апарат — розмова на 10 хвилин, не бриф на 10 сторінок.",
  },
  {
  ...
  },
  {
    ...
    text: "Апарат працює у вас тиждень. Команда п'є каву, ви оцінюєте сервіс — до підпису, а не після.",
  },
  {
