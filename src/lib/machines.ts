  ...
  },
  {
    ...
    photo: {
      ...
      callouts: [
        ...
        { x: 0.15, y: 0.2, label: "24 напої", side: "left" },
        { x: 0.2, y: 0.62, label: "Чашка за секунди", side: "left" },
        { x: 0.79, y: 0.51, label: "Регульована температура", side: "right" },
        { x: 0.79, y: 0.76, label: "Молоко в комплекті", side: "right" },
      ],
    },
  },
  {
