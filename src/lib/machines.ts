...
export const MACHINES: Machine[] = [
  {
    ...
    metaDescription:
      "Bianchi Gaia Touch в оренду для офісу: просте меню, 8 напоїв. Кавомашина, зерно, сервіс і підтримка — в одного партнера. Безкоштовно від 12 кг кави на місяць.",
    intro:
  ...
  },
  {
    ...
    metaDescription:
      "Dr. Coffee Minibar S — модель, яку обирають найчастіше: 24 напої, оренда для бізнесу в Києві та області. Безкоштовно від 15 кг кави на місяць, сервіс включено.",
    intro:
  ...
  },
  {
    ...
    metaDescription:
      "Dr. Coffee Coffeebar Plus витримує щоденний потік людей: 24 напої, оренда для бізнесу в Києві та області. Безкоштовно від 15 кг кави на місяць, сервіс включено.",
    intro:
  ...
  },
  {
    ...
    metaDescription:
      "Dr. Coffee Coffeecenter розрахований на промислове навантаження: 24 напої для великих команд у Києві. Безкоштовно від 20 кг кави на місяць, сервіс включено.",
    intro:
  ...
  },
  {
    ...
    metaDescription:
      "Bianchi Talia Touch — преміальна кавомашина в оренду для переговорних і представницьких просторів у Києві. Безкоштовно від 15 кг кави на місяць.",
    intro:
