...
const EXPECTATIONS = [
  ...
  "Апарат, який не ламається напередодні важливої зустрічі",
];
...
const STEPS = [
  {
    ...
    text: "Скільки людей, який ритм дня, де стоятиме апарат — розмова на 10 хвилин.",
  },
  {
  ...
  {
    title: "Встановлюємо",
    text: "Підключаємо апарат, налаштовуємо помел і пропорції під вашу воду й зерно на місці.",
  },
  {
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Додаємо апарат або переходимо на модель із більшим навантаженням без розірвання договору — інфраструктура масштабується разом із командою.",
  },
  {
