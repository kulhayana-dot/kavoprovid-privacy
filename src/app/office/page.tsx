...
const DESCRIPTION =
  "Кавове забезпечення офісу під ключ: обладнання, кава, постачання й сервіс від Kavoprovid у Києві та області. Один партнер замість підрядників.";
...
const WE_HANDLE = [
  ...
  "Безкоштовна доставка обладнання",
