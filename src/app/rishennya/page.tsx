...
const DESCRIPTION =
  "Обладнання — частина кавової інфраструктури Kavoprovid: кавомашина, кава, сервіс і підтримка працюють як одна система для офісів і виробництв у Києві та Київській області.";
