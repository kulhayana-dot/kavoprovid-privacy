        ...
        <div className="mx-auto max-w-3xl px-6 lg:px-8">
          ...
          <section className="mt-10">
            ...
            <p className="mt-4 text-ink/70">
              ...
              Ви можете вимкнути cookie-файли в налаштуваннях браузера;
              це не обмежить перегляд сайту, а лише збір статистики.
            </p>
          </section>
          ...
          <section className="mt-10">
            ...
            <ul className="mt-4 list-disc space-y-2 pl-6 text-ink/70">
              ...
              <li>
                Відмовитися від аналітичних cookie-файлів у налаштуваннях
                браузера;
              </li>
              <li>
