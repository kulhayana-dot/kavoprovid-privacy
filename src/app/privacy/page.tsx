        ...
        <div className="mx-auto max-w-3xl px-6 lg:px-8">
          ...
          <div className="mt-8 space-y-6 text-ink/70">
            ...
            <p>
              ...
              користуються окремим мобільним застосунком KAVOPROVID App,
              керуються окремою політикою конфіденційності застосунку — вона
              тут не публікується.
            </p>
          </div>
          ...
          <section className="mt-10">
            ...
            <ul className="mt-4 list-disc space-y-2 pl-6 text-ink/70">
              ...
              <li>
                <strong className="text-ink">Контактні дані:</strong> ім&apos;я,
                номер телефону та (необов&apos;язково) назва компанії — якщо
                ви самі залишаєте їх у формі заявки на сайті, або
                телефонуєте чи пишете на номер/email, вказані на сайті.
                Дані з форми використовуються лише для того, щоб зв&apos;язатися
                з вами.
              </li>
              <li>
          ...
          <section className="mt-10">
            ...
            <ul className="mt-4 list-disc space-y-2 pl-6 text-ink/70">
              ...
              <li>
                Зв&apos;язатися з вами у відповідь на заявку, залишену через
                форму на сайті, або звернення за контактами, вказаними на
                сайті.
              </li>
          ...
          <section className="mt-10">
            ...
            <ul className="mt-4 list-disc space-y-2 pl-6 text-ink/70">
              ...
              <li>
                Telegram — дані з форми заявки надсилаються туди, щоб наша
                команда одразу отримала звернення й могла зв&apos;язатися з
                вами;
              </li>
              <li>
